...
urlpatterns = [
	...
	path('viewProducts/<str:pk>/reviewProduct/', views.reviewProduct, name="reviewProduct"),
	path('viewProducts/<str:pk>/delete_review/<str:rk>/', views.delete_review, name="delete_review"),
